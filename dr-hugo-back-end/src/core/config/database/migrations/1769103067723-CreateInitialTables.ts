...
export class CreateInitialTables1769103067723 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "dv_doctor_specialization" (
                ...
                CONSTRAINT "UQ_dv_doctor_specialization_rqe" UNIQUE ("rqe")
            )
        `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dv_institution_company" DROP CONSTRAINT "FK_dv_institution_company_representative"`);
        await queryRunner.query(`ALTER TABLE "dv_institution_company" DROP CONSTRAINT "FK_dv_institution_company_institution"`);
        await queryRunner.query(`ALTER TABLE "dv_institution" DROP CONSTRAINT "FK_dv_institution_address"`);
        await queryRunner.query(`ALTER TABLE "dv_institution" DROP CONSTRAINT "FK_dv_institution_user"`);
        await queryRunner.query(`ALTER TABLE "dv_doctor_specialization" DROP CONSTRAINT "FK_dv_doctor_specialization_doctor"`);
        await queryRunner.query(`ALTER TABLE "dv_doctor" DROP CONSTRAINT "FK_dv_doctor_registration"`);
        await queryRunner.query(`ALTER TABLE "dv_doctor" DROP CONSTRAINT "FK_dv_doctor_user"`);
