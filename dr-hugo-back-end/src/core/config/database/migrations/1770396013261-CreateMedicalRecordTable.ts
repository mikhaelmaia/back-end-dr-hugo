  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE "dv_patient_medical_record" (
        ...
        CONSTRAINT "FK_dv_patient_medical_record_patient"
    ...
    await queryRunner.query(`
      CREATE INDEX "IDX_dv_patient_medical_record_patient_id"
      ON "dv_patient_medical_record" ("patient_id")
    `);

    await queryRunner.query(`
      CREATE INDEX "IDX_dv_patient_medical_record_is_active"
      ON "dv_patient_medical_record" ("is_active")
    `);
  }
